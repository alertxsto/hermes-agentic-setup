---
name: webreaper
description: "Scrape/crawl/extract clean Markdown or structured JSON via the webreaper CLI."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [webreaper, scraping, crawl, markdown, extraction]
    related_skills: [firecrawl, browser-automation]
---
